...
class FightGmWindow(ca_gui.GmWindow):
    ...
    def __show_fighter_notes(self,
        ...
        if fighter_state == ca_fighter.Fighter.FIGHT:
            ...
            mode = curses.color_pair(ca_gui.GmWindowManager.MAGENTA_BLACK) | curses.A_BOLD
...
class ScreenHandler(object):
    ...
    def _print_help(self):
        ...
        colors = [curses.A_BOLD, #curses.color_pair(ca_gui.GmWindowManager.CYAN_BLACK),
                  curses.A_NORMAL]
        color_index = 1
...
class PersonnelHandler(ScreenHandler):
    ...
    def __init__(self,
        ...
        self.__equipment_manager = ca_equipment.EquipmentManager(self.world,
                                                                 window_manager)
    ...
    def __setup_PC_list(self,
        ...
        if group is not None:
            ...
            if monsters is not None:
                ...
                #  fight =  Venue(
                #   group,
                #   self.world.details['fights'][group]['monsters'][
                #                                       ca_fighter.Venue.name],
                #   self.world.ruleset)
                ...
                if filename is None:
                    ...
                    while filename is None:
                        ...
                        if os.path.exists(filename):
                            ...
                            game_file = ca_json.GmJson(filename, window_manager)
